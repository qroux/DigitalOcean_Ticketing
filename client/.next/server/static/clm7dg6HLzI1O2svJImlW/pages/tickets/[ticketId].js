...
const TicketShow = ({
  ...
  const {
    ...
    onSuccess: order => next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push('/orders/[orderId]', `/orders/${order.id}`)
  });
  ...
  const purchaseBtn = () => {
    ...
    return __jsx("button", {
      onClick: () => next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push('/auth/signin'),
      className: "btn btn-primary"
    }, "Pruchase");
  };
